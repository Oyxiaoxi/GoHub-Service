...
欢迎来到 GoHub-Service 文档中心！这里提供了项目的完整开发指南。
...
### 快速入门
- **[QUICKSTART.md](./QUICKSTART.md)** - 5分钟快速搭建，适合新手

### 核心设计
- **[ARCHITECTURE.md](./ARCHITECTURE.md)** - 系统架构、分层设计、项目结构
- **[RBAC.md](./RBAC.md)** - 权限系统完整指南
